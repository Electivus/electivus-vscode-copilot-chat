...
export const ACCEPT_DIFF_COMMAND = 'electivus.copilot.chat.copilotCLI.acceptDiff';
export const REJECT_DIFF_COMMAND = 'electivus.copilot.chat.copilotCLI.rejectDiff';
