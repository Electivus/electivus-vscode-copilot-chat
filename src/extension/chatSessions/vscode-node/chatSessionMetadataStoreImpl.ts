...
const WORKSPACE_FOLDER_MEMENTO_KEY = 'electivus.copilot.cli.sessionWorkspaceFolders';
const WORKTREE_MEMENTO_KEY = 'electivus.copilot.cli.sessionWorktrees';
...
export class ChatSessionMetadataStore extends Disposable implements IChatSessionMetadataStore {
	...
	constructor(
		...
		this._cacheDirectory = Uri.joinPath(this.extensionContext.globalStorageUri, 'electivus-copilotcli');
