...
const OPEN_REPOSITORY_COMMAND_ID = 'electivus.copilot.chat.cloudSessions.openRepository';
const CLEAR_CACHES_COMMAND_ID = 'electivus.copilot.chat.cloudSessions.clearCaches';
...
export class CopilotCloudSessionsProvider extends Disposable implements vscode.ChatSessionContentProvider, vscode.ChatSessionItemProvider {
	public static readonly TYPE = 'electivus-copilot-cloud-agent';
	...
	private registerCommands() {
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.checkoutPullRequestReroute', checkoutPullRequestReroute));
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.openPullRequestReroute', openPullRequestReroute));
	...
	async provideChatSessionItems(token: vscode.CancellationToken): Promise<vscode.ChatSessionItem[]> {
		...
		this.chatSessionItemsPromise = (async () => {
			...
			vscode.commands.executeCommand('setContext', 'electivus.copilot.chat.cloudSessionsEmpty', filteredSessions.length === 0);
	...
	async delegate(
		...
		return {
			...
			command: {
				...
				command: 'electivus.copilot.chat.openPullRequestReroute',
