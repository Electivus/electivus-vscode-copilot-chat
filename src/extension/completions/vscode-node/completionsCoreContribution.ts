...
export class CompletionsCoreContribution extends Disposable {
	...
	constructor(
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'electivus.copilot.extensionUnification.activated', extensionUnification);
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'electivus.copilot.activated', token !== undefined);
		}));
	}
}
