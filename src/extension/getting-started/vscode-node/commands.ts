...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
		this._register(vscode.commands.registerCommand('electivus.copilot.open.walkthrough', () => {
			vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'Electivus.electivus-vscode-copilot-chat#copilotWelcome' }, /* toSide */ false);
		}));

		this._register(vscode.commands.registerCommand('electivus.copilot.mcp.viewContext7', () => {
