...
${message}`,
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review', () => instaService.createInstance(ReviewSession).review('selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.stagedChanges', () => instaService.createInstance(ReviewSession).review('index', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.unstagedChanges', () => instaService.createInstance(ReviewSession).review('workingTree', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.changes', () => instaService.createInstance(ReviewSession).review('all', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.stagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.unstagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.codeReview.run', (input: CodeReviewInput) => {
		return instaService.invokeFunction(reviewFileChanges, input);
	}));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('electivus.copilot.chat.generateAltText', doGenerateAltText));
