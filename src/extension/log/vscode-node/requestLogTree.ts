...
const exportLogItemCommand = 'electivus.copilot.chat.debug.exportLogItem';
const exportPromptArchiveCommand = 'electivus.copilot.chat.debug.exportPromptArchive';
...
const exportPromptLogsAsJsonCommand = 'electivus.copilot.chat.debug.exportPromptLogsAsJson';
const exportAllPromptLogsAsJsonCommand = 'electivus.copilot.chat.debug.exportAllPromptLogsAsJson';
const saveCurrentMarkdownCommand = 'electivus.copilot.chat.debug.saveCurrentMarkdown';
const showRawRequestBodyCommand = 'electivus.copilot.chat.debug.showRawRequestBody';
...
export class RequestLogTree extends Disposable implements IExtensionContribution {
	...
	constructor(
		...
		this._register(vscode.window.registerTreeDataProvider('electivus-copilot-chat-debug', this.chatRequestProvider));
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.debug.showOutputChannel', async () => {
			outputChannel.show();
		}));
	}
}
...
class LogTreeFilters extends Disposable {
	...
	private getStorageKey(name: string): string {
		return `electivus.copilot.chat.debug.${name}Hidden`;
	}
	...
	private setShown(name: string, value: boolean): void {
		vscode.commands.executeCommand('setContext', `electivus.copilot.chat.debug.${name}Hidden`, !value);
...
class LogTreeFilterCommands extends Disposable {
	constructor(filters: LogTreeFilters) {
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.showElements', () => filters.setElementsShown(true)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.hideElements', () => filters.setElementsShown(false)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.showTools', () => filters.setToolsShown(true)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.hideTools', () => filters.setToolsShown(false)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.showNesRequests', () => filters.setNesRequestsShown(true)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.hideNesRequests', () => filters.setNesRequestsShown(false)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.showGhostRequests', () => filters.setGhostRequestsShown(true)));
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.debug.hideGhostRequests', () => filters.setGhostRequestsShown(false)));
	}
}
