...
export class ToolsContribution extends Disposable {
	constructor(
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.debug.resetVirtualToolGroups', async () => {
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.tools.memory.showMemories', async () => {
		...
		this._register(vscode.commands.registerCommand('electivus.copilot.chat.tools.memory.clearMemories', async () => {
