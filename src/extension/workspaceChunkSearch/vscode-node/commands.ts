...
export const buildRemoteIndexCommandId = 'electivus.copilot.buildRemoteWorkspaceIndex';
export const deleteExternalIngestWorkspaceIndexCommandId = 'electivus.copilot.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('electivus.copilot.debug.collectWorkspaceIndexDiagnostics', async () => {
