...
describe('NESProvider Facade', () => {
	it('should handle getNextEdit call with a document URI', async () => {
		...
		nextEditProvider.updateTreatmentVariables({
			'config.electivus.copilot.chat.advanced.inlineEdits.xtabProvider.defaultModelConfigurationString': '{ "modelName": "xtab-test", "promptingStrategy": "copilotNesXtab", "includeTagsInCurrentFile": false }',
		});
