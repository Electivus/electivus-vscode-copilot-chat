...
export class UserInfoStore extends Disposable {
	...
	static INTERNAL_ORG_STORAGE_KEY = 'exp.electivus.copilot.internalOrg';
	static SKU_STORAGE_KEY = 'exp.electivus.copilot.sku';
	static IS_FCV1_STORAGE_KEY = 'exp.electivus.copilot.isFcv1';
	static IS_SN_STORAGE_KEY = 'exp.electivus.copilot.isSn';
	static IS_VSCODE_TEAM_MEMBER_STORAGE_KEY = 'exp.electivus.copilot.isVscodeTeamMember';
	static ORGANIZATION_LIST_STORAGE_KEY = 'exp.electivus.copilot.organizationList';
