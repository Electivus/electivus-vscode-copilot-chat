...
ssuite({ title: 'settingsEditorSearchResultsSelector', location: 'external' }, () => {
	...
	stest({ description: 'Selects expected agent mode setting' }, async (testingServiceCollection) => {
		...
		const settingsList: SettingListItem[] = [
			{
				'key': 'electivus.copilot.chat.codesearch.enabled',
				'type': 'boolean',
			...
			{
				'key': 'electivus.copilot.chat.agent.runTasks',
				'type': 'boolean',
			...
			{
				'key': 'electivus.copilot.advanced',
				'type': 'object'
			},
			{
				'key': 'electivus.copilot.chat.newWorkspaceCreation.enabled',
				'type': 'boolean',
			...
			{
				'key': 'electivus.copilot.chat.completionContext.typescript.mode',
				'type': 'string',
			...
			{
				'key': 'electivus.copilot.chat.agent.thinkingTool',
				'type': 'boolean',
